(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope, $translate) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('sakuraNekoJ2EeApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-sakuraNekoJ2EeApp-error');
                var entityKey = httpResponse.headers('X-sakuraNekoJ2EeApp-params');
                if (errorHeader) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('sakuraNekoJ2EeApp.' + fieldError.objectName + '.' + convertedField);
